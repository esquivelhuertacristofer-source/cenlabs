...
const genMaq=P3.maquinaElectrica(MATP,{d:0.48,largo:0.62,eje:0.30,aletas:14});
genMaq.rotation.y=Math.PI;   // el lado de accionamiento mira a -X
genG.add(genMaq);
/* LA POLEA, con sus GARGANTAS: por ahi entra el par del motor primario que
   arrastra a este generador. */
