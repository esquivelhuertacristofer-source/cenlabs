...
document.getElementById('panel').innerHTML=`
  ...
  <div id="tele">
    <div class="g"><div class="l">Vdc</div><b id="t_vdc">—</b></div>
    <div class="g"><div class="l">Vr(pp)</div><b id="t_vrpp">—</b></div>
    <div class="g"><div class="l">Rizo r</div><b id="t_r">—</b></div>
    <div class="g"><div class="l">Frec. de rizo</div><b id="t_fr">—</b></div>
    <div class="g"><div class="l">PIV requerido</div><b id="t_piv">—</b></div>
    <div class="g"><div class="l">PIV medido</div><b id="t_pivm">—</b></div>
    <div class="g"><div class="l">Id prom./diodo</div><b id="t_id">—</b></div>
    <div class="g"><div class="l">Id pico/diodo</div><b id="t_ip">—</b></div>
  </div>
...
window.__labDebug={
  ...
  setFreq:i=>{if(mode==='predice')return;freqIdx=i;onChange();},
