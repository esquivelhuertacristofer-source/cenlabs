...
const S=createStage(mount,{cam:[3.6,2.6,6.4],target:[0.55,1.25,0.10],bgTop:'#0d1017',bgBot:'#05060a',bloom:0.42,minD:3.0,maxD:20});
const {scene}=S;
...
const MODE_META={
  banco:{nombre:'Banco de ensayo',cam:[[3.6,2.6,6.4],[0.55,1.25,0.10]],
