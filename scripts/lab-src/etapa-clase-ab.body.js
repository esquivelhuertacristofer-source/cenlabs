...
(function () {
  ...
  function drawGraph(ctx) {
    ...
    // ---------- Curva de transferencia (distorsión de cruce) ----------
    ...
    // ---------- Pdiss(Vo_pk) — el "pico oculto" en 2Vcc/π ----------
    ctx.fillStyle = '#6b8a83'; ctx.font = '10px sans-serif';
    ...
    ctx.stroke();
    // Marca del peor caso teórico (2Vcc/π ≈ 0.637)
  ...
  function newReto() {
    ...
    const vcc = VCC_VALS[vi], rl = RL_VALS[ri];
    state._reto = { vcc, rl };
  ...
  window.__labDebug = {
    ...
    solveClaseAB, pdissEachAtFrac, classifyTj, transferCurve,
    curSolve,
