...
const S=createStage(mount,{cam:[5.4,2.7,5.4],target:[2.0,0.95,0.6],bgTop:'#0d1017',bgBot:'#05060a',bloom:0.42,minD:3.2,maxD:18});
const {scene}=S;
...
const MODE_META={
  mando:{nombre:'Mando',cam:[[5.4,2.7,5.4],[2.0,0.95,0.6]],
