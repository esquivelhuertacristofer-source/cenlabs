...
(function () {
  ...
  function checkReto() {
    ...
    if (res.outOfRange) {
    ...
    } else if (res.deltaV < minDelta) {
      showToast(`ΔV=${fmtV(res.deltaV)} < 1.5×ruido (${fmtV(minDelta)}): va a rebotar. Sube R1 o baja R2.`, 'warn');
      ...
      showToast(`✅ Diseño válido: ΔV=${fmtV(res.deltaV)} está dentro del rango seguro.`, 'ok');
    }
  }
