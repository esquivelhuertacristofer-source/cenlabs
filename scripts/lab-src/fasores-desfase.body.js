...
const gen1=makeGen(0.95,'GEN1','Generador 1 · referencia fija (10 V, 0°)');
const gen2=makeGen(1.85,'GEN2','Generador 2 · señal a caracterizar');
...
function refreshNet3D(){
  ...
  if(mode==='explora'){
    ...
    gen2.knob.visible=true;gen2.knob.rotation.z=expPhi2*Math.PI/180;
  }else if(mode==='medicion'){
...
// ============================== 9) MODOS Y SELBAR ==============================
const MODE_META={
  explora:{nombre:'Explora',cam:[[3.0,2.2,6.6],[0.4,1.2,0.0]],mision:'Ajusta Vm2, f y φ2 del canal 2 y observa cómo cambian el osciloscopio y el diagrama fasorial en tiempo real.'},
  ...
  reto:{nombre:'Reto',cam:[[2.4,1.9,4.0],[1.5,1.0,0.5]],mision:'Amplitud y desfase del canal 2 sellados. Lee Vm2 en la rejilla y mide φ con los cursores.'},
};
