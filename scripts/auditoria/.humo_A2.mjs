/** Humo · d6-A2: ¿arranca, monta y pinta las siete vistas sin reventar? */
...
const desc = await pag.evaluate(() => window.__labDebug.piezasDescolocadas);
console.log('piezas descolocadas:', desc.length, desc.slice(0, 8).join(', '));
