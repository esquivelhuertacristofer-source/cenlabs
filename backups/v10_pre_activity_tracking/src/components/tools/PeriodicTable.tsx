...
const tableData: Element[] = [
  ...
  { z: 11, symbol: "Na", name: "Sodio", mass: 22.99, category: "Alcalino", color: "#E63946", x: 1, y: 3 },
  { z: 12, symbol: "Mg", name: "Magnesio", mass: 24.30, category: "Alcalinotérreo", color: "#457B9D", x: 2, y: 3 },
  { z: 13, symbol: "Al", name: "Aluminio", mass: 26.98, category: "Metal Pobre", color: "#A8DADC", x: 13, y: 3 },
  { z: 14, symbol: "Si", name: "Silicio", mass: 28.08, category: "Metaloide", color: "#A8DADC", x: 14, y: 3 },
  { z: 15, symbol: "P", name: "Fósforo", mass: 30.97, category: "No Metal", color: "#1D3557", x: 15, y: 3 },
  { z: 16, symbol: "S", name: "Azufre", mass: 32.06, category: "No Metal", color: "#1D3557", x: 16, y: 3 },
  { z: 17, symbol: "Cl", name: "Cloro", mass: 35.45, category: "Halógeno", color: "#8ECAE6", x: 17, y: 3 },
  { z: 18, symbol: "Ar", name: "Argón", mass: 39.94, category: "Gas Noble", color: "#FB8500", x: 18, y: 3 },
];
