    ...
    <section id="plataforma" className={`w-full py-32 px-6 ${styles.schoolGrid} bg-white relative z-20`}>
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
          ...
          >
            <img src="/images/landing/fisica.png" alt="Engine" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:scale-105 transition-transform duration-1000" />
