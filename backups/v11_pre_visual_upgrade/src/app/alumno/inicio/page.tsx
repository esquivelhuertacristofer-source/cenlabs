          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              >
                ...
                <div className={`absolute inset-0 bg-gradient-to-t ${fac.color} mix-blend-multiply opacity-60 group-hover:opacity-40 transition-opacity`}></div>
