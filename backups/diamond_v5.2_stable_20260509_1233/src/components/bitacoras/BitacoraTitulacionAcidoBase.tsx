...
import { FlaskConical, Calculator, CheckCircle2, AlertCircle, Info, ChevronRight, Activity, Beaker, Bot, Volume2, Microscope, ShieldCheck, BookOpen } from 'lucide-react';
