    ...
    <div className="space-y-6 animate-in fade-in duration-500 font-['Outfit'] pb-20">
      ...
      <div className="bg-slate-50 rounded-[2rem] border border-slate-200 p-6 overflow-hidden relative shadow-sm">
         ...
         <div className="space-y-4">
            {/* Hallazgo: Eficiencia */}
            <div className={`p-4 rounded-2xl border transition-all flex items-center justify-between ${color === 'azul' || color === 'rojo' ? 'bg-emerald-500/10 border-emerald-500/30' : 'bg-white border-slate-100'}`}>
               <div className="flex flex-col">
                  <span className={`text-[8px] font-black uppercase tracking-widest ${color === 'azul' || color === 'rojo' ? 'text-emerald-600' : 'text-slate-400'}`}>
               ...
               <div className={`w-2 h-2 rounded-full ${color === 'azul' || color === 'rojo' ? 'bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]' : 'bg-slate-300'}`} />
            </div>

            {/* Hallazgo: Producción */}
            <div className={`p-4 rounded-2xl border transition-all flex items-center justify-between ${status === 'success' ? 'bg-emerald-500/10 border-emerald-500/30' : 'bg-white border-slate-100'}`}>
               <div className="flex flex-col">
                  <span className={`text-[8px] font-black uppercase tracking-widest ${status === 'success' ? 'text-emerald-600' : 'text-slate-400'}`}>
                     Acumulación de O₂
                  </span>
                  <span className="text-xs font-bold text-[#023047]">
               ...
               <div className={`w-2 h-2 rounded-full ${status === 'success' ? 'bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]' : 'bg-slate-300'}`} />
            </div>
         </div>
      </div>
