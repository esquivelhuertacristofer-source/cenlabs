    ...
    <div className="space-y-6 animate-in fade-in duration-500 font-['Outfit'] pb-20">
      ...
      <div className="bg-slate-50 rounded-[2rem] border border-slate-200 p-6 overflow-hidden relative shadow-sm">
         <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Registro de Hallazgos</h4>
         </div>

         <div className="space-y-4">
            <div className={`p-4 rounded-2xl border transition-all flex items-center justify-between ${checkInmersion ? 'bg-emerald-500/10 border-emerald-500/30' : 'bg-white border-slate-100'}`}>
               <div className="flex flex-col">
                  <span className={`text-[8px] font-black uppercase tracking-widest ${checkInmersion ? 'text-emerald-600' : 'text-slate-400'}`}>
                     Estado de Inmersión
                  </span>
               ...
               <div className={`w-2 h-2 rounded-full ${checkInmersion ? 'bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]' : 'bg-slate-300'}`} />
            </div>

            {/* Hallazgo: Fluido */}
            <div className={`p-4 rounded-2xl border transition-all flex items-center justify-between ${checkFluido ? 'bg-emerald-500/10 border-emerald-500/30' : 'bg-white border-slate-100'}`}>
               <div className="flex flex-col">
                  <span className={`text-[8px] font-black uppercase tracking-widest ${checkFluido ? 'text-emerald-600' : 'text-slate-400'}`}>
                     Medio de Referencia
                  </span>
                  <span className="text-xs font-bold text-[#023047]">
               ...
               <div className={`w-2 h-2 rounded-full ${checkFluido ? 'bg-emerald-500' : 'bg-slate-300'}`} />
            </div>

            {/* Hallazgo: Flotabilidad */}
            <div className={`p-4 rounded-2xl border transition-all flex items-center justify-between ${pesoAparente < pesoReal ? 'bg-emerald-500/10 border-emerald-500/30' : 'bg-white border-slate-100'}`}>
               <div className="flex flex-col">
                  <span className={`text-[8px] font-black uppercase tracking-widest ${pesoAparente < pesoReal ? 'text-emerald-600' : 'text-slate-400'}`}>
               ...
               <div className={`w-2 h-2 rounded-full ${pesoAparente < pesoReal ? 'bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]' : 'bg-slate-300'}`} />
            </div>
         </div>
      </div>
