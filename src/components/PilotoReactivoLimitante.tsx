  ...
  const startSynthesis = () => {
    ...
    setTimeout(() => {
      ...
      if (yieldAccuracy > 95 && ratioAccuracy > 95) {
        ...
        setAsistente({
          visible: true,
          text: "¡Excelente precisión! Los resultados son nominales. Ahora dirígete a la bitácora en la barra lateral para validar tus hallazgos y obtener tu certificación.",
          pose: "happy"
        });
      } else {
        audio?.playError?.();
        ...
        setAsistente({
          visible: true,
          text: "El rendimiento es subóptimo. Revisa el ratio estequiométrico y asegúrate de no tener reactivo en exceso antes de sintetizar.",
          pose: "puzzled"
        });
      }
    }, 2500);
