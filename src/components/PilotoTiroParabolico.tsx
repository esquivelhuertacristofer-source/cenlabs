...
export default function PilotoTiroParabolico() {
  ...
  }, [velocidad, rad, y0, tiro1, resultado, obsX, distanciaReal, G]);
  ...
  return (
    <div className="flex h-full w-full bg-[#010409] overflow-hidden font-['Outfit'] relative text-white">
      ...
      <AnimatePresence>
        {resultado && (
          <motion.div 
            ...
            className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[100] flex flex-col items-center pointer-events-none p-12 rounded-[4rem] backdrop-blur-3xl border shadow-3xl ${
