...
import { 
  ...
  Info, FileText, Search, X, Monitor, MonitorOff,
  ...
  Square, Grid, TrendingUp, Move, Cpu, AlertCircle, ListChecks, ClipboardList, CheckSquare
} from "lucide-react";
...
export default function PlaneamientoContent() {
