...
normatividad:          # 🔒 verificar clave y vigencia
  - "IEC 60076-1 'Power transformers — Part 1: General' — norma ancla explícita de la fila d5-02 en la lista maestra; Cláusula 11.4 (medición de la pérdida y corriente en vacío) y Cláusula 11.5 (medición de la impedancia de cortocircuito y la pérdida de carga)."
...
banderas_incertidumbre:
  ...
  - "⚑ Los números de cláusula de IEC 60076-1 (11.4, 11.5) y de ANSI/IEEE C57.12.90 (Cláusula 8) se citan de la mejor referencia disponible al momento de escribir este lab, sin confirmación de alta confianza contra el texto vigente de la norma ni año de edición específico — confirmar antes de publicar la trazabilidad con año."
