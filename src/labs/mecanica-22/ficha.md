...
fuentes:               # 🔒 sin fuente = marcar 'verificar'
  ...
  - "International Rectifier, datasheet 'IRLZ44N' PD-9.1346B (25/8/97) — Vth, gfs, Qg, RDS(on), ID máx, VDS máx y Ptot del IRLZ44N; única hoja de datos localizada para este número de parte pese a búsqueda exhaustiva, a diferencia del IRF540N no se encontró una reedición Infineon posterior que la reconfirme."
...
banderas_incertidumbre:
  ...
  - "⚑ El IRF540N muestra una discrepancia de proceso de fabricación real entre dos revisiones de hoja de datos del mismo fabricante: PD-91341A (1998) reporta gfs=11S mínimo, Qg=94nC máx y RDS(on)=52mΩ máx, mientras que PD-94812 (vigente desde 2003) reporta gfs≥21S, Qg=71nC máx y RDS(on)=44mΩ máx — se usó la revisión vigente (PD-94812) en todo el simulador y la ficha técnica por ser la más reciente, pero se pide al experto confirmar si el plantel tiene acceso a réplicas de terceros que pudieran mostrar cifras aún distintas para el mismo número de parte."
  - "⚑ Corrección de fuente — el IRLZ44N solo tiene UNA hoja de datos primaria localizada (International Rectifier PD-9.1346B, 25/8/97) pese a búsqueda exhaustiva; no se encontró una reedición Infineon posterior que la reconfirme, a diferencia del IRF540N. Se corrige aquí una afirmación previa de esta ficha y de la ficha técnica en app (`_ficha-mosfet.js`) que citaba 'reedición Infineon 2003' y 'dos documentos independientes' para el IRLZ44N — esa cita no pudo verificarse en la investigación y ha sido retirada de ambos documentos. Tratar el IRLZ44N como fuente única hasta nueva verificación."
