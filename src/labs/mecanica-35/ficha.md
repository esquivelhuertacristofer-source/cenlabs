...
desarrollo:            # 🔒 los pasos técnicos — revisión experta
  ...
  - "Confirma que el simulador clasifica automáticamente la respuesta según Q —sobre-amortiguada (Q<0.7071), Butterworth (Q≈0.7071, dentro de ±0.03), con pico de resonancia (0.7071<Q≤8), o inestable (Q>8)— y que dos accesos directos del panel saltan a Rf=0 (sobre-amortiguada) y al valor de Rf más alto disponible (inestable) para observar ambos extremos sin tener que ajustar el stepper paso a paso."
